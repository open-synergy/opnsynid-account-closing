...
class TestOnchange(TransactionCase):
    ...
    def test_prepaid_income_amortization_onchange_move_line_id(self):
        values = {
    ...
    def test_prepaid_income_amortization_onchange_contra_account_id(self):
        ...
        self.assertEqual(amortization.contra_account_id, self.income_account1)

    def test_prepaid_income_amortization_onchange_journal_id(self):
